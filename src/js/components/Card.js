...
export default function Card({title, description, technologies, website, github, source}){
    return (
        <section className='card'>
            ...
            <div className='svg-links'>
                {
                    website && 
                    <a href={website} aria-label="Visit website">
                ...
                {
                    github &&
                    <a href={github} aria-label="Visit github repo">
                ...
                {
                    source &&
                    <a href={source} aria-label="Visit source code">
